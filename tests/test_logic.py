...
def test_strategy_mode_of_defaults_to_twap():
    ...
    assert DEFAULT_SETTINGS["strategy_rev"] == 31
...
def test_ws_wanted_tokens_caps_and_prefers_5m_with_ptb():
    ...
    # 4×5m = 8 tokens, room for at most 4 more 15m tokens (2 books)
